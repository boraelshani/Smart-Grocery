...
# I want to replace everything from `<div class="card-body d-flex flex-column h-100"` up to `{% endfor %}`
...
replacement = r'''<div class="card-body d-flex flex-column h-100" style="background-color: #fff;">
