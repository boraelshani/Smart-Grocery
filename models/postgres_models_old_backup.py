"""
ORM MODELS — Maps the normalized PostgreSQL schema to Python objects.
This file has been updated to match the restructured database schema.
"""
...
class PriceHistory(db.Model):
    ...
    def to_dict(self):
        return {'id': str(self.id), 'offer_id': self.offer_id,
                ...
                'changed_at': (self.changed_at or self.recorded_at).isoformat() if (self.changed_at or self.recorded_at) else None,
                'source': self.source}
